...
//                  site-overrides.json 에 적힌 16곳은 거기 적힌 값(era·desc 포함)을 그대로 쓰고,
...
// ${records.length}건. regionTag/elevationProfile 은 site-overrides.json 의 16곳만 실제 값, 나머지는 기본값("plain").
